...
if __name__ == '__main__':
    ...
    checkpoint = ModelCheckpoint('data/fft_embedding/model.h5', verbose=1, monitor='val_loss',save_best_only=True, mode='auto')
    '''
    ...
    np.save('data/fft_embedding/X_train', embeddings)
    embeddings = model.predict(val_features)
    np.save('data/fft_embedding/X_test', embeddings)
